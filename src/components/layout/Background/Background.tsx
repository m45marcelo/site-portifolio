...
export const Background: React.FC<BackgroundProps> = ({children}) => {
    return(
        <div className="w-full max-w-[1360px] h-screen relative">
            ...
            <div className="absolute top-419.25 xl:right-140 rounded-full blur-[13.125rem] h-51.5 w-51.5 bg-secundary"/>
            <div className="absolute top-600 xl:right-140 rounded-full blur-[13.125rem] h-51.5 w-51.5 bg-secundary"/>
            {children}
        </div>
    )
}