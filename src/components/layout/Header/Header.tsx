    ...
    return(
        <header className="h-17.5 w-full px-20 border-b border-b-border-header flex items-center justify-between">
            ...
            <nav className="h-full flex items-center justify-between">
                <a href="#g" className="text-white font-fira-sans font-medium flex items-center justify-center drop-shadow-[0_0_4px] drop-shadow-primary text-[1rem] bg-primary rounded-[1.25rem] h-7.5 px-7.5">Home</a>
