...
export const SectionProjects = () => {
    return(
        <section id="projects" className="w-full max-w-299.5 flex flex-col items-center mb-15 px-5 xl:px-0">
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-5 w-full">
                <CardProject />
                <CardProject />
                <CardProject />
                <CardProject />
