...
export const SectionSkills = () => {
	return (
		<section id="skills" className="xl:h-150 w-full max-w-299.5 flex flex-col items-center mb-15 lg:px-10 px-5 xl:px-0">
            ...
            <div className="sm:grid-cols-3 sm:grid-rows-2 xl:h-130 w-fit xl:w-full grid md:grid-cols-2 md:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-5 ">
