...
export const CardSkill: React.FC<CardSkillProps> = ({icon, skilName, skillDescription}) => {
    return(
        <div className="flex flex-col text-center items-center justify-items-start  w-full max-w-96.5 h-62.5 px-5 pt-5 pb-5 border border-card-border bg-card-background rounded-lg">
            ...
            <CustomH2 className="text-[1.125rem] w-86.25 font-medium mb-3 h-5.5">{skilName}</CustomH2>
            <CustomText className="text-base font-normal text-text-gray leading-4.75">{skillDescription}</CustomText>
        </div>
    )
}